...
Barbarian::Barbarian() : Character("Barbarian", 0, 12, 0)
{
...
void Barbarian::defend(Character *attacker, int attackTotal) {
    int defenseTotal = 0;
    int currentRoll = 0;
    for (int i = 0; i < defenseRoll.numDice; i++) {
    ...
    int damage = max(attackTotal - defenseTotal - this->getArmor(), 0);
